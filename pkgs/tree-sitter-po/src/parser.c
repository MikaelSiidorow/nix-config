...
enum ts_symbol_identifiers {
  ...
  sym_message = 16,
  sym_comments = 17,
  sym_obsolete_entry = 18,
  sym_comment = 19,
  sym_msgctxt = 20,
  sym_msgid = 21,
  sym_msgid_plural = 22,
  sym_msgstr = 23,
  sym_msgstr_plural = 24,
  aux_sym_source_file_repeat1 = 25,
  aux_sym_message_repeat1 = 26,
  aux_sym_comments_repeat1 = 27,
  aux_sym_obsolete_entry_repeat1 = 28,
  aux_sym_msgctxt_repeat1 = 29,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [sym_obsolete_entry] = "obsolete_entry",
  [sym_comment] = "comment",
  [sym_msgctxt] = "msgctxt",
  [sym_msgid] = "msgid",
  ...
  [aux_sym_obsolete_entry_repeat1] = "obsolete_entry_repeat1",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_obsolete_entry] = sym_obsolete_entry,
  ...
  [aux_sym_obsolete_entry_repeat1] = aux_sym_obsolete_entry_repeat1,
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [aux_sym_obsolete_entry_repeat1] = {
    .visible = false,
    .named = false,
  },
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 32:
      ...
      if (set_contains(sym_string_character_set_1, 11, lookahead)) ADVANCE(5);
      END_STATE();
    case 33:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_message] = STATE(3),
    [sym_comments] = STATE(25),
    [sym_obsolete_entry] = STATE(3),
    [sym_comment] = STATE(14),
    [sym_msgctxt] = STATE(36),
    [sym_msgid] = STATE(22),
    [aux_sym_source_file_repeat1] = STATE(3),
    [aux_sym_comments_repeat1] = STATE(14),
    [aux_sym_obsolete_entry_repeat1] = STATE(12),
    [ts_builtin_sym_end] = ACTIONS(3),
    [sym_translator_comment] = ACTIONS(5),
    [sym_extracted_comment] = ACTIONS(7),
    [sym_reference_comment] = ACTIONS(7),
    [sym_flag_comment] = ACTIONS(7),
    [sym_previous_comment] = ACTIONS(7),
    [sym_obsolete_comment] = ACTIONS(9),
    [anon_sym_msgctxt] = ACTIONS(11),
    [anon_sym_msgid] = ACTIONS(13),
  },
  [STATE(2)] = {
    [sym_message] = STATE(2),
    [sym_comments] = STATE(25),
    [sym_obsolete_entry] = STATE(2),
    [sym_comment] = STATE(14),
    [sym_msgctxt] = STATE(36),
    [sym_msgid] = STATE(22),
    ...
    [sym_translator_comment] = ACTIONS(17),
    [sym_extracted_comment] = ACTIONS(20),
    [sym_reference_comment] = ACTIONS(20),
    [sym_flag_comment] = ACTIONS(20),
    [sym_previous_comment] = ACTIONS(20),
    [sym_obsolete_comment] = ACTIONS(23),
    [anon_sym_msgctxt] = ACTIONS(26),
    [anon_sym_msgid] = ACTIONS(29),
  },
  [STATE(3)] = {
    [sym_message] = STATE(2),
    [sym_comments] = STATE(25),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  ...
  [26] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(33),
  ...
  [34] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_msgctxt_repeat1, 2, 0, 0),
  [36] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_msgctxt_repeat1, 2, 0, 0),
  [38] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_msgctxt_repeat1, 2, 0, 0), SHIFT_REPEAT(4),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_message, 2, 0, 0),
  [43] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_message, 2, 0, 0),
  [45] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_msgstr_plural, 4, 0, 0),
  [49] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_msgstr_plural, 4, 0, 0),
  [51] = {.entry = {.count = 1, .reusable = true}}, SHIFT(4),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_message, 4, 0, 0),
  [55] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_message, 4, 0, 0),
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_message, 3, 0, 0),
  [59] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_message, 3, 0, 0),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_message, 5, 0, 0),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_message, 5, 0, 0),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_message_repeat1, 2, 0, 0),
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_message_repeat1, 2, 0, 0),
  [69] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_message_repeat1, 2, 0, 0), SHIFT_REPEAT(40),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_msgstr, 2, 0, 0),
  [74] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_msgstr, 2, 0, 0),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_obsolete_entry, 1, 0, 0),
  [78] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_obsolete_entry, 1, 0, 0),
  [80] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [82] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_comments_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  [85] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_comments_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_comments_repeat1, 2, 0, 0),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comments, 1, 0, 0),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_obsolete_entry, 2, 0, 0),
  [94] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_obsolete_entry, 2, 0, 0),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_obsolete_entry_repeat1, 2, 0, 0),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_obsolete_entry_repeat1, 2, 0, 0),
  [100] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_obsolete_entry_repeat1, 2, 0, 0), SHIFT_REPEAT(16),
  ...
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_msgid, 2, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_msgid, 2, 0, 0),
  [117] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_msgid_plural, 2, 0, 0),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_msgid_plural, 2, 0, 0),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_msgctxt, 2, 0, 0),
